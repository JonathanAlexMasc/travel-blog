...
export default function ContactPage() {
    ...
    return (
        <Container fluid className="d-flex flex-lg-row flex-column p-3 align-items-center">
            <Container fluid className="p-3">
                <img src={moi} alt="pic of me" className="img-fluid"></img>
            </Container>
            <Container fluid className="p-3 m-3 d-flex flex-column">
                ...
                <form name="contact" method="post" className="m-3">

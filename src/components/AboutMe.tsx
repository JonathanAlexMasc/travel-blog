...
export default function AboutMe() {
    return (
        <Container fluid className="d-flex flex-column gap-4 align-content-center m-4">
            <Container fluid className="d-flex flex-column text-white text-center bg-secondary p-3 w-75" data-bs-theme="dark">
